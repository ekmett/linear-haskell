...
-- keys allow you to swap the contents of the refs
...
-- paradox if you ever see two of them
singular# :: HasCallStack => Key# s a %1 -> Key# s b %1 -> r
singular# = error "Unlifted.Key.singular: duplicate key"

-- morally a lens
key# :: forall s a b. Ref# s -> Key# s a %1 -> (# a, b %1 -> Key# s b #)
key# (Ref# p) = Unsafe.toLinear go where
